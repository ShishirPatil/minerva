...
Options:
********
Full DFU is main2.c in the src folder. Change to main.c and compile.

main.c is setup to simply download a file from a server.

Quick Setup:
************
Change host and file path in prf.conf.
...
* Toolchain for nRF9160, instructions can be found here. https://github.com/lab11/nrf9x-base
