...
# This script takes the compiled binary and extracts the
# container code and container data sections of memory so that
# we can send these to the currently running app to update
def main():
    ...
    # Generate a .h file in C that will contain the data and code update contents.
    # This is so that we can include the update contents into our test applications
    # statically and avoid having to send them over the air. 
    with open(output_file, 'w') as f:
        f.write('unsigned char __ContainerCodeContents[4096] = {\n  ')
        ...
        f.write('unsigned char __ContainerDataContents[65536] = {\n  ')
    ...
    # Compile and run the the C program which hashes the contents of the update, and then make a file checksum.h 
